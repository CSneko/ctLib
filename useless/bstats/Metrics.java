 ...
 */
package org.cneko.ctlib.mod.common.util.bstats;
...
public class Metrics {
        ...
        try {
            ...
            metricsBase =
                    new MetricsBase(
                            ...
                            submitDataTask -> executor.submit(submitDataTask),
                            true,
    ...
    private void appendPlatformData(JsonObjectBuilder builder) {
        ...
        builder.appendField("onlineMode", plugin.getServerInfo().getOnlineMode() ? 1 : 0);
        builder.appendField("bukkitVersion", plugin.getServerInfo().getVersion());
        builder.appendField("bukkitName", plugin.getServerInfo().getName());
    ...
    public static class MetricsBase {
        ...
        private final boolean checkServiceEnabledSupplier;
        ...
        public MetricsBase(
                ...
                boolean checkServiceEnabledSupplier,
